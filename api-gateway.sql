...
-- ----------------------------
BEGIN;
INSERT INTO `application_interface` VALUES (16, 'api-gateshield-test-provider', 'com.yyl.gateshield.rpc.IActivityBooth', '活动服务', '1.0.0', '2023-01-01 10:02:15', '2023-01-01 10:02:15');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `application_interface_method` VALUES (43, 'api-gateshield-test-provider', 'cn.bugstack.gateway.rpc.IActivityBooth', 'sayHi', '探活方法', 'java.lang.String', '/wg/activity/sayHi', 'GET', 0, '2023-01-01 10:02:15', '2023-01-01 10:02:15');
INSERT INTO `application_interface_method` VALUES (44, 'api-gateshield-test-provider', 'cn.bugstack.gateway.rpc.IActivityBooth', 'insert', '插入方法', 'cn.bugstack.gateway.rpc.dto.XReq', '/wg/activity/insert', 'POST', 1, '2023-01-01 10:02:15', '2023-01-01 10:02:15');
INSERT INTO `application_interface_method` VALUES (45, 'api-gateshield-test-provider', 'cn.bugstack.gateway.rpc.IActivityBooth', 'test', '测试方法', 'java.lang.String,cn.bugstack.gateway.rpc.dto.XReq', '/wg/activity/test', 'POST', 0, '2023-01-01 10:02:15', '2023-01-01 10:02:15');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `application_system` VALUES (21, 'api-gateshield-test-provider', '网关sdk测试工程', 'RPC', 'zookeeper://192.168.1.102:2181', '2023-01-01 10:02:15', '2023-01-01 10:02:15');
INSERT INTO `application_system` VALUES (22, 'api-gateshield-sdk-00', '网关sdk测试工程', 'RPC', 'zookeeper://192.168.1.105:2181', '2023-03-11 11:20:08', '2023-03-11 11:20:08');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gateway_distribution` VALUES (1, '10001', 'api-gateway-g4', 'api-gateshield-test-provider', '测试工程', '2022-11-26 13:13:00', '2022-11-26 13:13:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gateway_server` VALUES (1, '10001', '测试网关1');
INSERT INTO `gateway_server` VALUES (2, '10002', '测试网关2');
INSERT INTO `gateway_server` VALUES (3, '10003', '测试网关3');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gateway_server_detail` VALUES (24, '10001', 'api-gateshield-g4', '电商配送网关', '192.168.1.102:7398', '1', '2023-03-11 14:12:36', '2023-03-11 14:12:36');
INSERT INTO `gateway_server_detail` VALUES (25, '10001', 'api-gateshield-g4', '电商配送网关', '192.168.1.102:7397', '1', '2023-03-11 14:33:05', '2023-03-11 14:33:05');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `http_statement` VALUES (1, 'api-gateshield-test', 'com.yyl.gateshield.rpc.IActivityBooth', 'sayHi', 'java.lang.String', '/wg/activity/sayHi', 'GET', 0, '2022-10-22 15:30:00', '2022-10-22 15:30:00');
INSERT INTO `http_statement` VALUES (2, 'api-gateshield-test', 'com.yyl.gateshield.rpc.IActivityBooth', 'insert', 'com.yyl.gateshield.rpc.dto.XReq', '/wg/activity/insert', 'POST', 1, '2022-10-22 15:30:00', '2022-10-22 15:30:00');
COMMIT;
